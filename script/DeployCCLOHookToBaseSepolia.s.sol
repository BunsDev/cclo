...
contract CCLOHookScript is Script {
    ...
    function run() public {
        ...
        (address hookAddress, bytes32 salt) =
            HookMiner.find(CREATE2_DEPLOYER, permissions, type(CCLOHook).creationCode, abi.encode(address(manager), authorizedUser, BASE_SEPOLIA_CHAIN_ID, address(BASE_SEPOLIA_CCIP_ROUTER)));
