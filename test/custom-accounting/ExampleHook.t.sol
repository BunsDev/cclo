...
contract ExampleHookTest is Test, Deployers {
    ...
    function _printTestType(bool zeroForOne, int256 amountSpecified) pure internal {
    ...
    function _defaultTestSettings() pure internal returns (PoolSwapTest.TestSettings memory testSetting) {
